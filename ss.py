...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\photos.jpg")
        ...
        img1=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\studentdetails.jpg")
        ...
        img2=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\studentpage3.jpg")
        ...
        img3=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\background.jpg")
        ...
        img_left=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\att.jpg")
       ...
       # gender_entry=ttk.Entry(class_Student_frame,textvariable=self.var_gender,width=20,font=("times new roman",13,"bold"))
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=35,font=("times new roman",13,"bold"),bg="darkblue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=35,font=("times new roman",13,"bold"),bg="darkblue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\HP\OneDrive\Desktop\face recognition system\images\attendance.jpg")
        ...
        search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Serach System",font=("times new roman",13,"bold"))
        ...
        search_btn=Button(search_frame,text="Search",width=12,font=("times new roman",12,"bold"),bg="darkblue",fg="white")
